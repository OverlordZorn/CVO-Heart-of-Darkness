...
[CBA_fnc_globalSay3d, [driver _truck, "ahshit", 500], 75] call CBA_fnc_waitAndExecute;
...
[CBA_fnc_globalEvent, ["cvo_common_fnc_subtitles", [ "Smuggler", "Thats the end of the road...."] ], 85] call CBA_fnc_waitAndExecute;
[CBA_fnc_globalEvent, ["cvo_common_fnc_subtitles", [ "Smuggler", "The engine is dead."] ], 90] call CBA_fnc_waitAndExecute;
[CBA_fnc_globalEvent, ["cvo_common_fnc_subtitles", [ "Smuggler", "You will have to walk from here..."] ], 95] call CBA_fnc_waitAndExecute;
[CBA_fnc_globalEvent, ["cvo_common_fnc_subtitles", [ "Smuggler", "Dont worry my friend! It is not far anymore."] ], 100] call CBA_fnc_waitAndExecute;
[CBA_fnc_globalEvent, ["cvo_common_fnc_subtitles", [ "Smuggler", "You can see the church from here.."] ], 105] call CBA_fnc_waitAndExecute;
[CBA_fnc_globalEvent, ["cvo_common_fnc_subtitles", [ "Smuggler", "You dont see it? Hah! Just its just down the road!"] ], 110] call CBA_fnc_waitAndExecute;
[CBA_fnc_globalEvent, ["cvo_common_fnc_subtitles", [ "Smuggler", "I will meet you at the safehouse once you're done"] ], 115] call CBA_fnc_waitAndExecute;
[CBA_fnc_globalEvent, ["cvo_common_fnc_subtitles", [ "Smuggler", "Good Luck!"] ], 120] call CBA_fnc_waitAndExecute;
